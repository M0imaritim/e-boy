  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
      ...
      <main id="main-content">
        {/* Hero Section - Main conversion point */}
        <HeroSection />

        {/* Services Overview - Brief summary with CTA to full services page */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                From daily errands to special tasks, we handle it all with
                professionalism and care.
              </p>
            </div>

            {/* Services preview - show top 3-4 services */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300">
                Simple steps to get your errands done
              </p>
            </div>
        ...
        <section className="py-16 bg-white dark:bg-gray-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
              No hidden fees. Pay only for what you need. Starting from as low
              as KES 500 per errand.
            </p>

            <div className="bg-gradient-to-r from-emerald-500 to-blue-600 rounded-2xl p-8 text-white max-w-md mx-auto mb-8">
              <h3 className="text-2xl font-bold mb-2">Basic Errands</h3>
              <div className="text-4xl font-bold mb-2">KES 300</div>
              <p className="text-emerald-100">Simple tasks, quick completion</p>
            </div>
